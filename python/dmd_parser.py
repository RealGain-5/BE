...
# 명칭 규칙: RCPA1/RCPA2/RCPB1/RCPB2 (NIMS 표준)
#
# [실측 결과 - SAEUL2_20240823 기준]
# AI 1/2/3 그룹: 노이즈 플로어 (미연결)
# AI 4/1~6:  단일 변위 프로브 X방향 — 6채널 모두 동일 신호 (상관≈1.0)
# AI 5/1~6:  단일 변위 프로브 Y방향 — 6채널 모두 동일 신호 (상관≈1.0)
# → 유효 궤도는 RCPA1 1개뿐 (X=AI 4/*, Y=AI 5/*)
# 인접 채널 쌍 (1,2), (3,4), (5,6)은 완전히 동일한 신호이므로
# RCPA2/B1/B2는 RCPA1과 동일한 궤도를 표시함 (물리적 중복)
DMD_ORBIT_CHANNEL_MAP = {
    "RCPA1": {"x": "AI 4/1", "y": "AI 5/1"},
    "RCPA2": {"x": "AI 4/3", "y": "AI 5/3"},
    "RCPB1": {"x": "AI 4/5", "y": "AI 5/5"},
}
RCP_ORDER = ["RCPA1", "RCPA2", "RCPB1"]
